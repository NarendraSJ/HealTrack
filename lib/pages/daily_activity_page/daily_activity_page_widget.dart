...
import 'daily_activity_page_model.dart';
export 'daily_activity_page_model.dart';

class DailyActivityPageWidget extends StatefulWidget {
  const DailyActivityPageWidget({super.key});

  static String routeName = 'DailyActivityPage';
  static String routePath = '/dailyActivityPage';

  @override
  State<DailyActivityPageWidget> createState() =>
      _DailyActivityPageWidgetState();
}

class _DailyActivityPageWidgetState extends State<DailyActivityPageWidget> {
  late DailyActivityPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DailyActivityPageModel());
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    dailyActivityPageRealTimeValuesRecord?.spo2
                                        .toString(),
                                    'spo2_value',
                                  ),
                                  style: FlutterFlowTheme.of(context)
